...
public class ViewRisksClassTable {
	...
	public ViewRisksClassTable(final Composite parent,ARXResult result,DataHandle result2,Data data, ARXConfiguration config,ARXPopulationModel population,boolean input) {
		this.result=result;
