...
package org.deidentifier.arx.kettle.dialoge.resources;
    ...
    public ComponentGSSlider(final Composite parent) {
        ...
        this.canvas.addPaintListener(new PaintListener() {
            ...
            public void paintControl(PaintEvent e) {
                ...
                e.gc.drawText(Messages.getString("ARXPluginDialog.transformation.coding.0"), OFFSET, OFFSET); //$NON-NLS-1$

                e.gc.setBackground(COLOR_LIGHT);
                e.gc.fillPolygon(right);

                final String string = Messages.getString("ARXPluginDialog.transformation.coding.1"); //$NON-NLS-1$
                e.gc.setForeground(COLOR_TEXT);
        ...
        button.setText(Messages.getString("ARXPluginDialog.transformation.coding.2")); //$NON-NLS-1$
