 ...
 * <h3>Tabs</h3>
 * <ul>
 * <li>Tranformation Settings</li>
 * <li>Utility Measure</li>
 * <li>Attribut Weight</li>
 * <li>Coding Model</li>
 * </ul>
 * <h3>Visibility</h3> The Visibility of the Tabs is defined after the Support
 * through the Metrics from the Utility Measure Tab.
 * 
...
public class LayoutTransformationModel implements LayoutCompositeInterface {
	...
	/**
	 * The Tab Composites which are Used here and which we need for further
	 * action
	 */
	...
	/**
	 * Generates a new view for the Transformation Settings. Needs a GridLayout
	 * from the Parent
	 * 
	 * @param parent
	 ...
	 *            The PropsUI
	 * @param fieldNames
	 *            The Fieldnames for the AttributWeight Settings
	 */
	public LayoutTransformationModel(final Composite parent, ARXPluginMeta meta, final PropsUI props,
			String[] fieldNames) {
		this.meta = meta;
		this.props = props;
	 ...
	 * 
	 * @param description
	 *            The Metric Description from the ARX Project
	 */
	 ...
	 * 
	 * @see
	 * org.deidentifier.arx.kettle.dialoge.ARXPluginDialogInterface#getData()
	 */
	public void getData() {
